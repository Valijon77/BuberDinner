...
public class MenuMappingConfig : IRegister
{
    public void Register(TypeAdapterConfig config)
    {
        ...
        config.NewConfig<MenuSection, MenuSectionResponse>().Map(dest => dest, src => src.Id.Value);

        config.NewConfig<MenuItem, MenuItemResponse>().Map(dest => dest, src => src.Id.Value);
    }
}
