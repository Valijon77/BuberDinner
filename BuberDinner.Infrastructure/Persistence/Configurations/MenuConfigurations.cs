    ...
    private void ConfigureMenuReviewIdsTable(EntityTypeBuilder<Menu> builder)
    {
        builder.OwnsMany(
            ...
            mib =>
            {
                ...
                mib.HasKey("Id");
                mib.Property(mi => mi.Value).HasColumnName("ReviewId").ValueGeneratedNever();
            }
        );
    ...
    private void ConfigureMenuDinnerIdsTable(EntityTypeBuilder<Menu> builder)
    {
        builder.OwnsMany(
            ...
            dib =>
            {
                ...
                dib.Property(di => di.Value).HasColumnName("DinnerId").ValueGeneratedNever();
            }
        );
    ...
    private void ConfigureMenuSectionsTable(EntityTypeBuilder<Menu> builder)
    {
        builder.OwnsMany(
            ...
            sb =>
            {
                ...
                sb.WithOwner().HasForeignKey("MenuId"); // shadow property
